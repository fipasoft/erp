...
<head>
  ...
  <script type="text/javascript" src="<?php echo $js_path ?>system/jquery-ui-1.8.16/js/jquery-ui-1.8.16.custom.min.js"></script>
					...
					<div id="menu_container">
						...
						<?php if(Yii::app()->user->name != 'Guest'){ ?>		
							<div id="SCiclo" >
								...
								<a href="<?php echo $yiiBaseUrl ?>site/logout">Cerrar sesi&oacute;n</a> /
								...
								<div id="cicloSel" style="display:none;" class="derecha">
									<form id="frm_ciclo" method="post" action="<?php echo $yiiBaseUrl ?>site/ciclo">
										<div>
											<input type="hidden" name="controlador" value="<?php echo $controlador ?>" />
											<input type="hidden" name="YIIbaseUrl" id="YIIbaseUrl" value="<?php echo $yiiBaseUrl; ?>" />
